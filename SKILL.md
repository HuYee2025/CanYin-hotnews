...
| 来源 | URL | 内容 | 语言 |
|------|-----|------|------|
| 红餐网快讯 | https://www.canyin88.com/kuaixun/ | 今日餐饮行业快讯 | 中文 |
| 中国食品安全网 | https://www.cfsn.cn | 今日食品安全新闻 | 中文 |
| Food Dive | https://www.fooddive.com | 今日全球餐饮新闻 | 英文 |

**重要：只抓取今日最新资讯，不抓取热文排行（旧文章）**

**AI筛选流程：**
1. 抓取社交平台今日热点（微博/知乎/抖音/百度）
2. 从社交热点中筛选餐饮相关内容
3. 抓取餐饮专业资讯今日最新新闻
4. AI分析每条资讯的餐饮营销价值
5. 筛选出最有价值的内容
...
**任务：**
1. 抓取今日社交平台热点（微博/知乎/抖音/百度）
2. 从社交热点中筛选餐饮相关内容（关键词：餐饮、餐厅、美食、食品、饮品、茶饮、咖啡、火锅、烧烤等）
3. 抓取餐饮专业资讯今日最新新闻（红餐网快讯、中国食品安全网、Food Dive）
4. **只抓取今日或最近24小时的内容，不抓取旧文章**
5. AI分析每个热点是否有餐饮关联
6. 筛选出10条最有营销价值的热点
7. 提取餐饮切入点并给出营销建议
...
**格式要求：**
- 标题使用粗体编号 + Markdown链接格式（**01.** [标题](链接)）
- Markdown链接会自动显示为蓝色并可点击
- 编号使用粗体（**01.**、**02.**等）
- 关键字段加粗（**餐饮切入点：**、**营销建议：**）
- 每条新闻之间用分隔线（---）隔开
- 简洁美观，有视觉层次感
